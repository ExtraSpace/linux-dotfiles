...
values."
  (setq-default
   ...
   '(
     ...
     polymode
     (markdown :variables
               markdown-live-preview-engin 'vmd)
...
you should place your code here."
  ...
  (defun rmarkdown-insert-chunk (&optional name)
    (interactive
     (list
      (read-string "Chunk Name:")))
    (when (> (length name) 0) (setq name (concat " " name)))
  ...
  (spacemacs/set-leader-keys-for-major-mode
    'markdown-mode "ic" 'rmarkdown-insert-chunk)
  (spacemacs/set-leader-keys-for-major-mode
    'markdown-mode "ip" 'markdown-insert-gfm-code-block)
  ...
  ;; Fixing dead tilde key
  (define-key key-translation-map [dead-tilde] "~")

  ;; Close compilation buffer after success
